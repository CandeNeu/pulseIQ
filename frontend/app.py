...
st.markdown(
    "Fill in the patient's details, measure the pulse from a video, then predict."
)
...
# =====================================================================
# Patient details (with sensible defaults)
# =====================================================================
...
# =====================================================================
# Measure pulse from a video
# =====================================================================
st.header("Measure pulse")
st.caption(
...
# =====================================================================
# Predict — button stays disabled until a pulse has been measured
# =====================================================================
st.header("Predict")
...
if pulse_rate:
    ...
    st.info(
        "Upload a video (or use the camera) to measure the pulse before predicting."
    )

# Disabled until we have a measured pulse
predict_clicked = st.button(
    "Predict risk", type="primary", disabled=(pulse_rate is None)
)
